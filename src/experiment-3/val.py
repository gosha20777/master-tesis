...
import time
import os
from utils.utils import fun_ensemble_back, save_validation_image, fun_ensemble_numpy
...
def test():
    ...
    net1 = AWNet(4, 3, block=[3, 3, 3, 4, 4])

    net1.load_state_dict(
        torch.load('{}/weight_4channel_best.pkl'.format(config.weights_dir), map_location="cpu")["model_state"])
    print('weight loaded.')
